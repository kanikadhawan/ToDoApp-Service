 ...
 *
 */
@Repository("allTaskDAOImpl")
public class AllTaskDAOImpl implements TaskDAO {
	...
	public StringBuilder getTask(String taskType) {
		...
		String SQL = "SELECT TASK_ID, TASK_DESCRIPTION, TASK_TYPE FROM TABLE_ALL_TASK";
		   
		try {
		   JSONArray jsonArr = (JSONArray)jdbcTemplateObject.query(SQL,new ResultSetExtractor() {
